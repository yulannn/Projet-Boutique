import type { LocaleDefinition, MetadataDefinition } from '@faker-js/faker/dist/types/definitions';
import type { LocaleProxy } from '@faker-js/faker/dist/types/locale-proxy';
import { AirlineModule } from '@faker-js/faker/dist/types/modules/airline';
import { AnimalModule } from '@faker-js/faker/dist/types/modules/animal';
import { ColorModule } from '@faker-js/faker/dist/types/modules/color';
import { CommerceModule } from '@faker-js/faker/dist/types/modules/commerce';
import { CompanyModule } from '@faker-js/faker/dist/types/modules/company';
import { DatabaseModule } from '@faker-js/faker/dist/types/modules/database';
import { DateModule } from '@faker-js/faker/dist/types/modules/date';
import { FinanceModule } from '@faker-js/faker/dist/types/modules/finance';
import { GitModule } from '@faker-js/faker/dist/types/modules/git';
import { HackerModule } from '@faker-js/faker/dist/types/modules/hacker';
import { HelpersModule } from '@faker-js/faker/dist/types/modules/helpers';
import { ImageModule } from '@faker-js/faker/dist/types/modules/image';
import { InternetModule } from '@faker-js/faker/dist/types/modules/internet';
import type { LocationModule as AddressModule } from '@faker-js/faker/dist/types/modules/location';
import { LocationModule } from '@faker-js/faker/dist/types/modules/location';
import { LoremModule } from '@faker-js/faker/dist/types/modules/lorem';
import { MusicModule } from '@faker-js/faker/dist/types/modules/music';
import type { PersonModule as NameModule } from '@faker-js/faker/dist/types/modules/person';
import { PersonModule } from '@faker-js/faker/dist/types/modules/person';
import { PhoneModule } from '@faker-js/faker/dist/types/modules/phone';
import { RandomModule } from '@faker-js/faker/dist/types/modules/random';
import { ScienceModule } from '@faker-js/faker/dist/types/modules/science';
import { SystemModule } from '@faker-js/faker/dist/types/modules/system';
import { VehicleModule } from '@faker-js/faker/dist/types/modules/vehicle';
import { WordModule } from '@faker-js/faker/dist/types/modules/word';
import type { Randomizer } from '@faker-js/faker/dist/types/randomizer';
import { SimpleFaker } from '@faker-js/faker/dist/types/simple-faker';
/**
